...
public class Tutor extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        option1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Toast.makeText(Tutor.this, "Noted, let's confirm your order \uD83D\uDE4C\uD83C\uDFFB", Toast.LENGTH_SHORT).show();
                Intent OrderPage = new Intent(Tutor.this, TeachingMenu.class);
        ...
        option2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                isOnline();
                Toast.makeText(Tutor.this, "Amazing!! Here is a service Provider \uD83D\uDE4C\uD83C\uDFFB", Toast.LENGTH_SHORT).show();
                setContentView(R.layout.activity_webview_page);
                webView = findViewById(R.id.confirmpage_webpage);
                webView.setWebViewClient(new WebViewClient());
                webView.loadUrl("https://www.call2wash.com.my/");
                Toast.makeText(Tutor.this, "Loading.. ⌛", Toast.LENGTH_LONG).show();
                WebSettings webSettings = webView.getSettings();
                webSettings.setJavaScriptEnabled(true);
                webView.setWebViewClient(new WebViewClient());
                btnback = findViewById(R.id.backbtn);
        ...
        morebtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                isOnline();
                Toast.makeText(Tutor.this, "Sure ✨", Toast.LENGTH_SHORT).show();
                setContentView(R.layout.activity_webview_page);
                webView = findViewById(R.id.confirmpage_webpage);
                webView.setWebViewClient(new WebViewClient());
    ...
    public boolean isOnline() {
        ...
        if (netInfo != null && netInfo.isConnectedOrConnecting()) {
            ...
            Intent opensliderintent = new Intent(Tutor.this, no_internet.class);
